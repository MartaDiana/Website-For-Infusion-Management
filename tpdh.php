...
<body>
    ...
    <!-- Tanpa Dehidrasi -->
    <section class="tpdh" id="tpdh">
        <div class="container">
            <div class="row text-center">
                <div class="col-lg-12 mb-5">
                    <h1>Tatalaksana pada Pasien Tanpa Dehidrasi</h1>
                </div>
            </div>

            <div class="row penanganan">
                <div class="col-lg-12 ml-auto mr-sm-auto">
                    <p class="header">Proses Tatalaksana:</p>
                    <p>1. Pemberian oralit </p>
                    <p>2. Zink</p>
                    <p>3. Antibiotik selektif</p>
                    <p>4. Diet</p>
                    <p class="header">Dapat Kembali ke Rumah Sakit bila dalam 3 hari anak mengalami:</p>
                    <p>1. Demam</p>
                    <p>2. Tinja berdarah</p>
                    <p>3. Muntah berulang</p>
                    <p>4. Makan dan minum sedikit</p>
                    <p>5. Sering merasa sangat haus</p>
                    <p>6. Diare masih sering dan tidak membaik</p>
                </div>
            </div>
